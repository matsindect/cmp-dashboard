...
export const getBusinessTypes = createAsyncThunk('cmpSupplier/businessType/getBusinessTypes', async () => {
...
export const { selectAll: selectBusinessTypes, selectById: selectBusinessTypeById } = BusinessTypesAdapter.getSelectors(
	state => state.cmpSupplier.businessTypes
);

const BusinessTypesSlice = createSlice({
	name: 'cmpSupplier/businessTypes',
