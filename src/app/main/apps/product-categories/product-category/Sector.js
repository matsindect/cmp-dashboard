	...
	return (
		<FusePageCarded
								...
								<div className="flex flex-col min-w-0 mx-8 sm:mc-16">
									<FuseAnimate animation="transition.slideLeftIn" delay={300}>
										<Typography className="text-16 sm:text-20 truncate">
											{form.name ? form.name : 'New Product Category'}
										</Typography>
									</FuseAnimate>
									<FuseAnimate animation="transition.slideLeftIn" delay={300}>
										<Typography variant="caption">Product Category Detail</Typography>
									</FuseAnimate>
								</div>
							</div>
						</div>
			...
			contentToolbar={
				...
				>
					<Tab className="h-64 normal-case" label="Product Category Info" />
				</Tabs>
			}
			content={
				form && (
