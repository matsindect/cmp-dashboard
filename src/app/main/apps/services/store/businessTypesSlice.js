...
export const getBusinessTypes = createAsyncThunk('cmpServices/businessType/getBusinessTypes', async () => {
...
export const { selectAll: selectBusinessTypes, selectById: selectBusinessTypeById } = BusinessTypesAdapter.getSelectors(
	state => state.cmpServices.businessTypes
);

const BusinessTypesSlice = createSlice({
	name: 'cmpServices/businessTypes',
