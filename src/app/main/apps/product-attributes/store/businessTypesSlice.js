...
export const getBusinessTypes = createAsyncThunk('cmpProductAttributes/businessTypes/getBusinessTypes', async () => {
...
export const { selectAll: selectBusinessTypes, selectById: selectSectorById } = businessTypesAdapter.getSelectors(
	state => state.cmpProductAttributes.businessTypes
);

const businessTypesSlice = createSlice({
	name: 'cmpProductAttributes/businessTypes',
