...
export const getCategories = createAsyncThunk('cmpProductAttributes/categories/getCategories', async () => {
...
export const { selectAll: selectCategories, selectById: selectCategoriesById } = categoriesAdapter.getSelectors(
	state => state.cmpProductAttributes.categories
);

const categoriesSlice = createSlice({
	name: 'cmpProductAttributes/categories',
