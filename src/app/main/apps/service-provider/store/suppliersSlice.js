...
export const getSuppliers = createAsyncThunk('cmpServiceProvider/suppliers/getSuppliers', async () => {
...
export const { selectAll: selectSuppliers, selectById: selectSupplierById } = suppliersAdapter.getSelectors(
	state => state.cmpServiceProvider.suppliers
);

const suppliersSlice = createSlice({
	name: 'cmpServiceProvider/suppliers',
