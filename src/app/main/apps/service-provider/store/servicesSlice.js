...
export const getServices = createAsyncThunk('cmpServiceProvider/services/getServices', async () => {
...
export const { selectAll: selectServices, selectById: selectServicesById } = servicesAdapter.getSelectors(
	state => state.cmpServiceProvider.services
);

const servicesSlice = createSlice({
	name: 'cmpServiceProvider/services',
