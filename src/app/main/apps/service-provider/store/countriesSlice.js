...
export const getCountries = createAsyncThunk('cmpServiceProvider/countries/getCountries', async () => {
...
export const { selectAll: selectCountries, selectById: selecCountryById } = countriesAdapter.getSelectors(
	state => state.cmpServiceProvider.countries
);

const countriesSlice = createSlice({
	name: 'cmpServiceProvider/countries',
