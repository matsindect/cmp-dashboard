...
export const getSupplier = createAsyncThunk('cmpServiceProvider/supplier/getSupplier', async params => {
	console.log(params);
...
export const saveSupplier = createAsyncThunk('cmpServiceProvider/supplier/saveSupplier', async supplier => {
...
const supplierSlice = createSlice({
	name: 'cmpServiceProvider/supplier',
	initialState: null,
	reducers: {
		newSupplier: {
