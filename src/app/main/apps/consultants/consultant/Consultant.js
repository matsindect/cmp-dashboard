...
import { saveProduct, newProduct, getProduct } from '../store/consultantSlice';
								...
								<div className="flex flex-col min-w-0 mx-8 sm:mc-16">
									<FuseAnimate animation="transition.slideLeftIn" delay={300}>
										<Typography className="text-16 sm:text-20 truncate">
											{form.product_name ? form.product_name : 'New Consultant'}
										</Typography>
									</FuseAnimate>
									<FuseAnimate animation="transition.slideLeftIn" delay={300}>
										<Typography variant="caption">Consultant Detail</Typography>
									</FuseAnimate>
								</div>
							</div>
						</div>
